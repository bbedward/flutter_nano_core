...
import 'package:flutter_nano_core/ed25519_blake2.dart';
...
class NanoKeys {
  static String seedToPrivate(String seed, int index) {
    ...
    assert(index >= 0);
    return NanoHelpers.byteToHex(Hashes.digest256([NanoHelpers.hexToBytes(seed), Hashes.intToUint8List(index, 4)]));
  }
